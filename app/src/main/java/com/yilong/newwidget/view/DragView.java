...
public class DragView<T> extends FrameLayout {
    ...
    public void onDragPositionChange(int from, int to) {
        Log.d("clarkhu", "onDragPositionChange() from = " + from + "; to = " + to);
        if (from > to) {
    ...
    public void setCurrentDragPosition(int currentDragPosition) {
        Log.d("clarkhu", "setCurrentDragPosition() currentDragPosition = " + currentDragPosition);
    ...
    public int eventToPosition(MotionEvent ev) {
        if (ev != null) {
            ...
            if (position >= mChildCount) {
                ...
                Log.d("clarkhu", "eventToPosition: position = " + position);
                return position;
            }
        }
        return 0;
